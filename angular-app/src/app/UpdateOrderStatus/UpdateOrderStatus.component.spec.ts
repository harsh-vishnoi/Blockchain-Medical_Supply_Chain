...
describe('UpdateOrderStatusComponent', () => {
  ...
  let mockUpdateOrderStatusService;
  let mockDataService

  beforeEach(async(() => {

    mockUpdateOrderStatusService = sinon.createStubInstance(UpdateOrderStatusService);
    mockUpdateOrderStatusService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: UpdateOrderStatusService, useValue: mockUpdateOrderStatusService },
