...
async function issueLicense(tx){
  ...
  license.issueYear = tx.issueYear;
  license.expiryYear = tx.expiryYear;

  license.regulator = factory.newRelationship(namespace, 'Regulator', tx.regulator.getIdentifier());
